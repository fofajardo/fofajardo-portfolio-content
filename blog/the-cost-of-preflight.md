...
During peak usage, with CORS enabled and excluding Session 1, **fully loading the enlistment module takes at best, one (1) minute, and at worst, three (3) minutes**. This does not account for other factors (e.g., differences in internet providers).
